...
var fruits = ["bananes", "oranges", "fraise", "peche"];
for (ligne = 0; ligne < fruits.length; ligne++){
	console.log("ligne " + (ligne+1));
...
} while(fruits[ligne] != "bananes")
console.log("fin do while recherche bananes");
ligne = -1;
do{
	ligne ++;
	console.log("J'aime les " + fruits[ligne]);
} while(ligne < fruits.length-1)
console.log("fin do while affichage tableau");
ligne = 0
